...
export class MyDataComponent{
  ...
  $sort_click () {
    ...
    // 重新获取数据
    this.datasetservice.getDataSets(localStorage['username'] , this.s_select_datasetType=='all'?null:this.s_select_datasetType , this.s_select_name , this.s_sort_type, this.s_page , this.s_size ).subscribe(rep =>{
