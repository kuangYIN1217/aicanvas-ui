...
const training_network_service_1 = require("../../common/services/training-network.service");
const d3 = require("d3");
let VisualizedNetworkComponent = class VisualizedNetworkComponent {
    constructor(networkEditorService, parameterService, trainingNetworkService) {
        this.networkEditorService = networkEditorService;
        this.parameterService = parameterService;
        this.trainingNetworkService = trainingNetworkService;
    ...
    createLayer(layerType) {
        var layer = new training_network_1.Layer();
...
VisualizedNetworkComponent = __decorate([
    core_1.Component({
        ...
        providers: [parameter_service_1.ParameterService, training_network_service_1.TrainingNetworkService]
    }),
    __metadata("design:paramtypes", [network_editor_service_1.NetworkEditorService,
        parameter_service_1.ParameterService,
        training_network_service_1.TrainingNetworkService])
